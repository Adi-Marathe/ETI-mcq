...
def parse_ete_unit3(filepath):
    ...
    for i in range(1, len(parts), 2):
        ...
        explanation = f"The correct answer is {answer.split(') ')[1]} as per the Unit 3 syllabus on Smart Cities."
...
questions = parse_ete_unit3('ete_unit3_new.txt')
with open('../src/data/ete_unit3.json', 'w', encoding='utf-8') as f:
    json.dump(questions, f, indent=4)

print(f"Successfully processed {len(questions)} questions for ETE Unit 3.")
