...
def parse_unit4(input_file, output_file):
    ...
    for i in range(1, len(parts), 2):
        ...
        # In unit 4, there are no "Explanation:" blocks.
        ...
        if ')' in answer:
            ...
            ans_text = answer
        explanation = f"The correct answer is '{ans_text}'. This concept is essential to Immersive Technology and Sustainable Computing."
...
if __name__ == "__main__":
    parse_unit4("unit4_raw.txt", "src/data/unit4_questions.json")
